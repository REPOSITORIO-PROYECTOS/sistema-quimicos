...
export default function RegistrarPedidoPuertaPage() {
    ...
    const doPrintAndRedirect = (ventaId: number) => {
        ...
        window.print();
        setTimeout(() => { resetearFormulario(); irAccionesPuerta(); }, 10000);
    };
    ...
    return (
        <>
            ...
            {/* Modal para capturar teléfono del cliente cuando el total supera $10.000 */}
            {showPhoneModal && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 print:hidden">
                    <div className="bg-white p-6 rounded-lg shadow-2xl w-full max-w-md border border-gray-200">
                        ...
                        <p className="text-sm text-gray-600 mb-4">
                            El importe de la boleta supera $10.000. Antes de imprimir, ingrese el número de teléfono para registrarlo como cliente.
                        </p>
                        {phoneError && (
