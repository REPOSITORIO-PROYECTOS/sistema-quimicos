  ...
  return (
    <div className="min-h-screen bg-indigo-900 py-6 px-4">
      <div className="max-w-7xl mx-auto">
        <nav className="sticky top-0 z-10 bg-white shadow mb-4">
          <div className="px-4 py-3 flex flex-wrap gap-2">
            <Link href="/movimientos" className="px-4 py-2 rounded bg-gray-200 hover:bg-gray-300">Movimientos</Link>
            <Link href="/libro-mayor" className="px-4 py-2 rounded bg-indigo-600 text-white hover:bg-indigo-700">Libro Mayor</Link>
          </div>
        </nav>
